<template>
    <PageComponent>
        <template v-slot:header>
            ...
            <div class="grid grid-cols-1 gap-2 sm:frid-cols-2 md:grid-cols-3">
                <div v-for="survey in surveys" :key="survey.id" class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]">
                    ...
                    <div class="flex justify-between items-center mt-3">
                        <router-link :to="{ name: 'SurveyView', params: {id: survey.id}}" class="flex py-2 px-4 border border-transparent text-sm rounded-md text-white bg-indigo-700 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focues:ring-indigo-500">
                        ...
                        type="button"
                        class="h-8 w-8 rounded-full flex items-center justify-center border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                        >
